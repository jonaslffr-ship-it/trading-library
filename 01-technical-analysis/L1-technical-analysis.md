...
| Short-horizon index returns mean-revert (negative first-order autocorrelation) | Literature — (Jegadeesh & Titman 1993); reproducible from free daily data |
...
| Most technical rules' apparent profit does not survive data-snooping correction and costs | Literature — (Sullivan, Timmermann & White 1999; Park & Irwin 2007) |
